...
// proteção contra registro duplo. O 【0】 cobre a parte do offline que pode
// derrubar o app inteiro — a lib do CDN que não carrega.
const fs = require('fs');
...
html = html.replace('</body>', `<script>
  window.__t = {
    ...
    get OPTS(){return OPTS},            // criado só depois dos modelos (offline)
...
(async () => {
  ...
  console.log('\n【0】 Carregamento — a lib do CDN não pode derrubar o app');
  ok($('loading').style.display === 'none', 'tela de carregamento sai',
